...
void *socket_listener (void *args);   // thread function used to communicate with connected nodes
void *mpi_listener (void *args);   // thread function used to communicate with connected nodes
