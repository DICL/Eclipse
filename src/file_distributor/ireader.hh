...
//[wb]
		map<string,bool> is_key_read;

	public:
		ireader(int ajobid, int anumiblock, int anetworkidx, int hash_value, int abridgeid, bridgetype adsttype);
		void set_dstpeer(filepeer* apeer);
		void set_dstclient(file_connclient* aclient);
		bool read_idata();
};

ireader::ireader(int ajobid, int anumiblock, int anetworkidx, int hash_value, int abridgeid, bridgetype adsttype)
{
